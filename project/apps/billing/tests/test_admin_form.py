...
class TestCompanyAdminForm(TestCase):
    def test_add_users_without_company(self):
        ...
        form = CompanyAdminForm(
            data={"company_name": "Test", "users": [user1]}, instance=company
        )
    ...
    def test_add_users_with_company(self):
        ...
        form = CompanyAdminForm(
            data={"company_name": "Test", "users": [user1, user2]}, instance=company2
        )
    ...
    def test_create_company_without_users(self):
        form = CompanyAdminForm(data={"company_name": "Test create"})
        self.assertEqual(form.errors, {})
    ...
    def test_create_company_with_users(self):
        ...
        company = CompanyFactory()
        company.users.add(user1)
        form = CompanyAdminForm(data={"company_name": "Test", "users": [user1, user2]})
