        ...
        if form.is_valid():
            ...
            if activation_url is None:
                ...
                return render(
                    ...
                    context={
                        "error": f'Could not generate activation URL.<br> Please try registering <a href="{request.get_full_path()}">again</a>!'
                    },
                )
            ...
            if settings.REGISTRATION_EMAIL_CONFIRMATION:
                ...
                logger.info(
                    f'Activation email queued to be sent to "{user.email}". Dramatiq message_id: {activation_task.message_id}'
                )
